...
**茶思屋 Markdown 发布助手** 是一款简化 [黄大年茶思屋](https://www.chaspark.com) 网站发布 Markdown 文章操作步骤的 Chrome 浏览器扩展（同样适用于 Edge 浏览器）。它能够自动将本地 Markdown 文件及其引用的图片一键上传到茶思屋富文本编辑器中，大大简化了内容发布流程。
...
6. 安装完成！你应该能在扩展栏看到「茶思屋 Markdown 发布助手」

### 3. 固定扩展图标（推荐）

点击 Chrome 工具栏右上角的拼图图标 🧩，找到「茶思屋 Markdown 发布助手」，点击固定图标📌，方便日后快速访问。
...
2. **打开编辑器页面**：进入茶思屋的“学术热点”的发布页面：https://www.chaspark.com/#/hotspots/publish
